...
🌐 **公開URL**: https://kurokami-taro.github.io/ai-tools/

## 収録ツール

### HTML単一ファイル（ブラウザで開くだけ）
...
| ツール | 用途 |
|---|---|
| [token-trim/](./token-trim/) | AIに渡すコード・テキストのトークン数を削減するCLI |

## 特徴

- **完全無料**
- **インストール不要**（HTML版はブラウザで開くだけ）
- **オフライン動作**（外部CDN依存なし）
- **データローカル保存のみ**（外部送信なし）
...
これらのツールは Anthropic, Inc. および OpenAI 等と無関係の個人制作物です。
